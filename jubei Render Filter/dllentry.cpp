...
//
class __declspec(uuid("43722b64-d426-4aea-b58f-b463b147101f")) RenderFilterFactory : public UnknownBase<IClassFactory>
{
public:
    RenderFilterFactory() :
        m_serverLocks(0)
        ...
        )
    {
        ...
        *ppvObject = NULL;
        ...
        jubei_Render_Filter::RenderFilter *pFilter = NULL;
        ...
        try
        {
            ...
            pFilter = new jubei_Render_Filter::RenderFilter();
        }
        CATCH_VARIOUS(hr)
    ...
    )
{
    ...
    *ppv = NULL;
    ...
    if (rclsid != __uuidof(jubei_Render_Filter::RenderFilterFactory))
    {
    ...
    jubei_Render_Filter::RenderFilterFactory *pFactory = NULL;
    pFactory = new(std::nothrow) jubei_Render_Filter::RenderFilterFactory();
...
DllCanUnloadNow()
{
    return (0 == jubei_Render_Filter::RenderFilter::ms_numObjects) ? S_OK : S_FALSE;
}
    ...
    )
{
    ...
    case DLL_PROCESS_ATTACH:
        ...
        WPP_INIT_TRACING(L"jubeiRenderFilter");
